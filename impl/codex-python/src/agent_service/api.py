...
def create_app(
    ...
    def _capabilities_payload(resolved) -> Capabilities:
        ...
        return Capabilities(
            ...
            limits={
                ...
                # listing sessions needs this to size its window.
            ...
            mcp={
                ...
                # **All four NULL, and that is "no bound" rather than "not
                # looked"** (CX-60). `tool_timeout_sec` resolves to null on a
                # server this build writes and the binary carries no tool-call
                # timeout message at all -- the only MCP timeout it can emit
                # names the handshake. With no timer, `progress_resets_idle` has
