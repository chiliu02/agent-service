...
def build_capabilities(settings: Settings) -> Capabilities:
    ...
    return Deployment.from_flat(
        ...
        # **Split in two since 2026-09-03**: a ceiling on what a caller may ask
        # for and a figure this service enforces are different claims, and they
        # shared one map. This build publishes only the second kind.
        accepts_limits={},
        behaviour_limits={
