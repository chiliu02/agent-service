...
DOCUMENT_VERSION = "0.20.0"

#: This build. MUST equal `pyproject.toml`'s `version`. Starts at 0.0.1 rather
#: than at the document's number: the two streams are independent and this one
#: has shipped nothing.
...
IMPLEMENTATION_NAME = "gemini-python"
